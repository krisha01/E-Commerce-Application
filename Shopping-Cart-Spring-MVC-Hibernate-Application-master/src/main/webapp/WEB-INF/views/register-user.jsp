...
<body>
	...
	<h2>Hello! Welcome to the Registration page</h2><br>
		...
		<table>
			<tr>
				...
				<td><form:input path="firstName" size="30" required="required" />
					<font color="blue"><form:errors path="firstName" /></font></td>
			</tr>
			
			<tr>
				<td>Last Name:</td>
				<td><form:input path="lastName" size="30" required="required" />
					<font color="blue"><form:errors path="lastName" /></font></td>
			</tr>
			...
			<tr>
				...
				<td><form:input path="username" size="30" required="required" />
					<font color="blue"><form:errors path="username" /></font></td>
			</tr>
